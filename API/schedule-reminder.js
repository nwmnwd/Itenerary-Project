// api/schedule-reminder.js (Ini adalah Serverless Function)

const ONE_SIGNAL_APP_ID = "48d40efc-bfd6-44f5-ada5-30f2d1a17718"; // App ID kamu
const ONE_SIGNAL_REST_KEY = process.env.ONE_SIGNAL_REST_KEY; // Dapatkan dari ENV Vercel
